...
<html lang="en">
  ...
  <style >
    .bg-primary {
    background : -webkit-linear-gradient(left, #78c7ee, #8e74dd); 
    color: #d0d1d3;  /* fallback for old browsers */
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 0%;  padding-bottom: 20px; font-family: Sitka Text;"> Hello &nbsp<?php echo $username ?>....
   </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:25%; margin-top: -2%; margin-left: 35%; text-align:center; font-family: Times">
  ...
  <div class="col-md-8" style="margin-top: 5%; margin-left: 25%">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list" >
        <div class="container-fluid" style="font-family: Times">
          <div class="card">
            <div class="card-body">
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list" style="font-family: Times">
      ...
      <div class="tab-pane fade" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list" style="font-family: Times">
