...
.list-group-item.active {
  z-index: 2;
    color: #fff;
    background: #F0F2F0; 
    background: -webkit-linear-gradient(to right, #036572, #8e74dd);
    background: linear-gradient(to right, #036572, #8e74dd);
    border-color: #c3c3c3;
}
.text-primary {
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;text-align: center;">
    <h3 style = "margin-left: -88%; padding-bottom: 20px;font-family:Sitka Text;color:#8e74dd "> Hello &nbsp<?php echo $_SESSION['dname'] ?>....  </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:18%;margin-top: -2%;margin-left: 36.5%;font-family: Times">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" href="#list-dash" role="tab" aria-controls="home" data-toggle="list">Menu</a>
  ...
  <div class="col-md-8" style="margin-top: 3%;margin-left: 22%">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;font-family: Times">
