...
<link rel="stylesheet" type="text/css" href="style1.css?ver=<?php echo rand(111,999)?>">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item" style="margin-right: 60px;">
            <a class="nav-link js-scroll-trigger" href="index.php" style="color: white;font-family: Times;margin-top: 111%"><h6>HOME</h6></a>
          </li>


          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="contact.html" style="color: white;font-family: Times;margin-top: 60%"><h6>CONTACT US</h6></a>
          </li>
        </ul>
      </div>
    </div>
...
<div class="container register" style="font-family:  Times;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 7%;right: 15%">
                        <img src="images/pngegg.png" alt=""/>
                        <h3>Arogya Hospital</h3>
                       
                       
                    </div>
                    <div class="col-md-9 register-right" style="margin-top: 70px;left: 80px;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel" minlength="10" maxlength="10" name="contact" class="form-control" placeholder="Contact No."  />
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="tab-pane fade show" id="admin" role="tabpanel" aria-labelledby="profile-tab">
                                <h3  class="register-heading">Administrator Login</h3>
